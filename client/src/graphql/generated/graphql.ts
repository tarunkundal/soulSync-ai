...
export type UpdatePersonMutation = { updatePerson: { __typename: 'People', id: string, aiTonePreference: string, phoneNumber: string | null, whatsappEnabled: boolean | null, name: string, relationshipType: string } };
